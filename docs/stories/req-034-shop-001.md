...
- 기존 관계: 신규 (v.0.2)
- UI: [상품·재고 관리](../ux/wireframes/pages/18-products/index.html)
...
- [ ] AC-01 상품 등록 — 구현·검증 (CC-834)
- [ ] AC-02 판매 활성화 — 구현·검증 (CC-835)
- [ ] AC-03 삭제 제한 — 구현·검증 (CC-836)
- [ ] 관리 화면 구현 (와이어프레임 기준) (CC-837)
