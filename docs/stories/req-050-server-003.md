...
- 기존 관계: 신규 (v.0.2)
- UI: [배포·재기동 요청](../ux/wireframes/pages/26-deploy/index.html)
...
- [ ] AC-01 파이프라인 호출 — 구현·검증 (CC-896)
- [ ] AC-02 이중 확인 — 구현·검증 (CC-897)
- [ ] AC-03 상태 추적 — 구현·검증 (CC-898)
- [ ] 관리 화면 구현 (와이어프레임 기준) (CC-899)
